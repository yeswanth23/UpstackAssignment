...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
    	...
    	List<TestRequest> list = testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED);
    	return list;
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // For reference check the method assignForLabTest() method from LabRequestController class
		  ...
		  }catch (AppException e) { throw asBadRequest(e.getMessage()); }
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
        	...
        	result = testRequestUpdateService.updateConsultation(id, testResult, user);
        	return result;
            // replace this line of code with your implementation
